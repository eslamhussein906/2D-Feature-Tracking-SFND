...
int main(int argc, const char *argv[])
{
    ...
    {   
        ...
        if(imgIndex > dataBufferSize-1){     
            dataBuffer.erase(dataBuffer.begin()); // Remove old frame from dataBuffer
            DataFrame frame;
        ...
        cout << "****************** LOAD IMAGE "<<imgIndex+1<<"  INTO BUFFER done ***********" << endl;
        ...
        cout << "vehicle Kaypoints = "<< keypoints.size()<<" points"<<endl;

        /* EXTRACT KEYPOINT DESCRIPTORS */

        //the following descriptors in file matching2D.cpp and enable string-based selection based on descriptorType
